...
<template>
  ...
  <div class="block center">
    ...
    <text-line class="text" title="要修改的密码" v-model="password" type="password" />
    <div class="code">
    ...
    <div class="code">
      ...
      <click-button @click="send_email" ref="email_code_button"><p>发送验证码</p></click-button>
    </div>
    <p class="error" v-text="error"></p>
    <p>
      没有账号？<RouterLink class="links" to="/register">去注册</RouterLink> 要登录？<RouterLink
        class="links"
        to="/login"
        >去登录</RouterLink
      >
