...
<template>
  <div class="chat">
    <div class="history" ref="history">
      ...
      >
        <div class="message-box">
          <p class="info" v-text="message.role === 'assistant' ? 'AI' : 'User'"></p>
          <div class="content" v-html="message.content" v-if="message.role === 'assistant'"></div>
    ...
    <div class="input">
      ...
      <click-button @click="sendMessage" class="submit" :disabled="isButtonDisabled"
